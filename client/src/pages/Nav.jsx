    ...
    return (
        <div className='shadow-md w-full fixed top-0 left-0 z-20'>
            ...
            ease-in ${open ? 'top-20 opacity-100' : 'top-[-490px]'} md:opacity-100 opacity-0`}>
                    ...
                    duration-500 mr-8 md:ml-8 md:mr-0' onClick={openModal}>SignUp
                    </button>
                    {/* signup modal */}
                    {showModal && (
                        <div>
                                ...
                                <div className="w-[600px]">
                                    ...
                                    <button className="text-black text-xl place-self-end" onClick={closeModal}>X</button>
                                        ...
                                        <h1 className="font-bold text-2xl">Welcome! :)</h1>
                                            ...
                                            <label className="font-semibold text-xs mt-3" htmlFor="passwordField">Last Name</label>
                                            <input className="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 rounded focus:outline-none focus:ring-2" type="text" />
                                            <label className="font-semibold text-xs mt-3" htmlFor="passwordField">Username</label>
                                            <input className="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 rounded focus:outline-none focus:ring-2" type="text" />
                                            <label className="font-semibold text-xs mt-3" htmlFor="passwordField">Email</label>
                                            <input className="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 rounded focus:outline-none focus:ring-2" type="text" />
