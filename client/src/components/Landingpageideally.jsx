...
export default function LandingPage() {
    ...
    return (
        ...
        <div className="bg-gradient-to-b from-orange-500 via-yellow-500 to-orange-400 min-h-screen">
        <div className="flex flex-col h-screen items-center justify-center">
          ...
          <div className="h-2/3 w-2/3 rounded-lg overflow-hidden border-double border-4 border-gray-600 bg-gray-300/50 shadow-2xl shadow-black m-auto pt-12">
